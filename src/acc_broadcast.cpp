...
void AccBroadcast::_bind_methods() {
	...
	BIND_ENUM_CONSTANT(REGISTER_COMMAND_APPLICATION);
	BIND_ENUM_CONSTANT(REQUEST_ENTRY_LIST);
	BIND_ENUM_CONSTANT(REQUEST_TRACK_DATA);
	BIND_ENUM_CONSTANT(UNREGISTER_COMMAND_APPLICATION);

	BIND_ENUM_CONSTANT(BROADCASTING_EVENT);
	BIND_ENUM_CONSTANT(REALTIME_UPDATE);
	BIND_ENUM_CONSTANT(REGISTRATION_RESULT);
	BIND_ENUM_CONSTANT(REALTIME_UPDATE);
	BIND_ENUM_CONSTANT(REALTIME_CAR_UPDATE);
	BIND_ENUM_CONSTANT(ENTRY_LIST);
	BIND_ENUM_CONSTANT(ENTRY_LIST_CAR);
	BIND_ENUM_CONSTANT(TRACK_DATA);
}
